                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img src="./assets/compiled/svg/ball-triangle.svg" class="me-4" style="width: 3rem"
                            alt="audio">
                        <img src="./assets/compiled/svg/circles.svg" class="me-4" style="width: 3rem" alt="audio">
                        <img src="./assets/compiled/svg/grid.svg" class="me-4" style="width: 3rem" alt="audio">
                        <img src="./assets/compiled/svg/hearts.svg" class="me-4" style="width: 3rem" alt="audio">
                        <img src="./assets/compiled/svg/oval.svg" class="me-4" style="width: 3rem" alt="audio">
                        <img src="./assets/compiled/svg/puff.svg" class="me-4" style="width: 3rem" alt="audio">
                        <img src="./assets/compiled/svg/rings.svg" class="me-4" style="width: 3rem" alt="audio">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-12">
