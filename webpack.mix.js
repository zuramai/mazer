...
mix
  ...
  .js(`${assetsPath}js/extensions/parsley.js`, "assets/js/extensions")
  .js(`${assetsPath}js/extensions/parsley.init.js`, "assets/js/extensions")
  .js(`${assetsPath}js/extensions/parsley.custom.js`, "assets/js/extensions")
